...
SECRET_KEY = "django-insecure-uh%&t@!a*ot$38#8vl-15x^_exwtgviti1#f+x50$ho@)gpg0v"
...
# Initial Big Query Client:
SERVICE_ACCOUNT_JSON_PATH = os.getenv('SERVICE_ACCOUNT_JSON_PATH')
BIGQUERY_PROJECT          = os.getenv('BIGQUERY_PROJECT')
BIGQUERY_BILLING_PROJECT  = os.getenv('BIGQUERY_BILLING_PROJECT')
