...
export const metadata: Metadata = {
  title: "Sipher CRM Dashboard SignIn",
  description: "Sipher CRM Dashboard SignIn",
};
  ...
  return (
    <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      <div className="flex flex-wrap items-center">
        <div className="hidden w-full xl:block xl:w-1/2 bg-black">
          <div className="px-26 py-17.5 text-center">
            <Link className="flex justify-around align-baseline" href="/auth/signin">
              <Image
                ...
                height={150}
              />
              <p className="font-bold text-title-xl2 text-red">
                Sipher Odyssey CRM Dashboard
              </p>
            </Link>
            ...
            <form>
              ...
              <div className="mt-6 text-center">
              {
                    ...
                    <div className="flex justify-center items-center">
                        <p className="text-red">Invalid Email Or Password. Please Type Again</p>
                    </div>
                    )
                }
                <p>
